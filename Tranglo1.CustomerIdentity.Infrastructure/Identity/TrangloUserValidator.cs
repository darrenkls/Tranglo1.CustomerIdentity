...
namespace Microsoft.AspNetCore.Identity
{
    ...
    public class TrangloUserValidator<TUser> : IUserValidator<TUser> where TUser : class
    {
        /// <summary>
        /// Creates a new instance of <see cref="UserValidator{TUser}"/>/
        /// </summary>
        /// <param name="errors">The <see cref="IdentityErrorDescriber"/> used to provider error messages.</param>
        public TrangloUserValidator(IdentityErrorDescriber errors = null)
        {
        ...
        private async Task ValidateEmail(UserManager<TUser> manager, TUser user, List<IdentityError> errors)
        {
            ...
            var owner = await manager.FindByIdAsync(email);
            if (owner != null &&
