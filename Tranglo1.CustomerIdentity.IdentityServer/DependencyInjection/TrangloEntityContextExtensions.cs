...
{
	internal static class TrangloEntityContextExtensions
	{
		/// <summary>
		...
		/// <returns></returns>
		public static IServiceCollection AddTrangloEntityContext(this IServiceCollection services)
		{
			services.AddHttpContextAccessor();
			services.AddScoped<ITrangloEntityContext, DefaultTrangloEntityContext>();
			return services;
		}
	}
}
