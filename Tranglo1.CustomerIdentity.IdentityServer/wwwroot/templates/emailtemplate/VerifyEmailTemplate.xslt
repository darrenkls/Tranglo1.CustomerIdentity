    ...
    <xsl:template match="Profile">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                ...
                <br></br>
                <p>
                    Thank you for choosing us for your payments need.
                </p>
                <p>
                    <br></br>
                    To start using your account, click the button below to verify your email address.
                </p>
                <br></br>
                <b>
                    <xsl:element name="a">
                        ...
                        <xsl:attribute name="href">
                            <xsl:value-of select="ConfirmationUrl"/>
                        </xsl:attribute>
                        <span style="color:White"> Confirm my email address</span>.
                    </xsl:element>
                </b>
                <br></br>
                <br></br>
