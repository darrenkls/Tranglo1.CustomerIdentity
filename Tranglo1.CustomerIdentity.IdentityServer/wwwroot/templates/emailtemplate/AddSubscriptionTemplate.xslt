...
>
	...
	<xsl:template match="Profile">
		<xsl:param name="SubscriptionList" select="SubscriptionList"/>
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					Below subscription(s) have been added for <span style="color:Green"><xsl:value-of select="PartnerName"/></span>.
					
					<br></br>
					<!--<xsl:value-of select="SubscriptionList"/>-->

					<xsl:for-each select="tokenize($SubscriptionList, '@')[.]">
						<category>
					...
					Partner Type:  <xsl:value-of select="PartnerType"/>
