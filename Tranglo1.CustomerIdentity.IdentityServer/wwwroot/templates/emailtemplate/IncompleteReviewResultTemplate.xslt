	...
	<xsl:template match="Profile">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<br></br>
				<p>
					Your business KYC details have been compliance reviewed.There are feedbacks
				...
				<br></br>
				<p>
					Please contact <xsl:value-of select="Email1"/>  or <xsl:value-of select="Email2"/>  if you need any further assistance.
				</p>
				<br></br>
				<br></br>
				<p>Thank you.</p>
